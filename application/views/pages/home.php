      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2">
          <div class="service-info">
            <div class="icon">
              <img src="<?php echo base_url(); ?>assets/img/layanan1.png">
            </div>
            <div class="icon-info">
        ...
        <div class="col-md-2 col-sm-2">
          <div class="service-info">
            <div class="icon">
              <img src="<?php echo base_url(); ?>assets/img/layanan2.png">
            </div>
            <div class="icon-info">
        ...
        <div class="col-md-2 col-sm-2">
          <div class="service-info">
            <div class="icon">
              <img src="<?php echo base_url(); ?>assets/img/layanan3.png">
            </div>
            <div class="icon-info">
              <h4>Edukasi Gigi</h4>
            </div>
        ...
        <div class="col-md-2 col-sm-2">
          <div class="service-info">
            <div class="icon">
              <img src="<?php echo base_url(); ?>assets/img/layanan4.png">
            </div>
            <div class="icon-info">
        ...
        <div class="col-md-2 col-sm-2">
          <div class="service-info">
            <div class="icon">
              <img src="<?php echo base_url(); ?>assets/img/layanan5.png">
            </div>
            <div class="icon-info">
